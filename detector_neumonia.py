...
def model_fun():
    if not hasattr(model_fun, "model"):
        ...
        model_fun.model = load_trained_model(model_path)
...
from read_img import read_jpg_file, read_dicom_file


def preprocess(array):
    # kept for backward compatibility; delegate to `preprocess_img.preprocess`
    from preprocess_img import preprocess as _preprocess
